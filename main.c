...
/*   Updated: 2020/01/25 15:57:28 by rgero            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
*/
 //	char *s = "random";
	 ...
	 i = ft_printf("%.lf|%-.lf|%+.lf|% .lf|%#.lf|%0.lf", 38546.5849, 38546.5849, 38546.5849, 38546.5849, 38546.5849, 38546.5849);
...
//	long double d = 1.0 / 3.0;
	i = printf("%.lf|%-.lf|%+.lf|% .lf|%#.lf|%0.lf", 38546.5849, 38546.5849, 38546.5849, 38546.5849, 38546.5849, 38546.5849);
	printf("\nres=%i=li\n", i);
