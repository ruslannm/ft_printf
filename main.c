...
/*   Updated: 2020/01/10 15:32:24 by rgero            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
//	i = ft_printf("%-+23d|%- 23d|%-023d|%+ 23d|%+023d|% 023d|%-+ 023d", 0, 0, 0, 0, 0, 0, 0);
	i = ft_printf("|%+023d|% 023d|", 0, 0);

	write(1, "\nres=", 5);
	ft_putnbr(i);
	write(1, "=my\n", 4);

	i = printf("%-+23d|%- 23d|%-023d|%+ 23d|%+023d|% 023d|%-+ 023d", 0, 0, 0, 0, 0, 0, 0);
	printf("\nres=%i=li\n", i);
